...
app.use(bodyParser.urlencoded({ extended: true }));  // handle the form
app.use(express.static("public"));  // handle all folders/files inside the public folder
...
//function to query the current users 
...
// adding new country with validation
app.post("/add", async (req, res) => {
  const input = req.body["country"];
